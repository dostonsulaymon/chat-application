...
CREATE TABLE users (
                       ...
                       account_status VARCHAR(20) CHECK (account_status IN ('ACTIVE', 'BLOCKED', 'IN_REGISTRATION')),
                       user_role VARCHAR(20) CHECK (user_role IN ('MEMBER_ROLE', 'MODERATOR_ROLE', 'ADMIN_ROLE', 'OWNER_ROLE', 'USER_ROLE')),
